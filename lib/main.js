...
import { pushTag } from './methods/pushTag.js';
...
import { stagedFiles } from './methods/stagedFiles.js';
import { stagedFilesWithStatus } from './methods/stagedFilesWithStatus.js';
...
export default function Gilmore(userRoot, userOptions = {}) {
  const rootPath = userRoot || gitRoot(process.cwd());
  const options = {
    globalConfig: true,
    ...userOptions,
  };
